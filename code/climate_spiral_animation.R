...
a <- t_data %>% 
  ...
  geom_rect(aes(xmin = 1, xmax = 13, ymin = -2.5, ymax = 2.4), 
  ...
  labs( x = NULL,
        y = NULL,
        title = "Global temperature change (1880-2023)"
  ) +
  theme(
    panel.background = element_rect(fill = "#444444",  size = 1),
    plot.background = element_rect(fill = "#444444", colour = "#444444"),
